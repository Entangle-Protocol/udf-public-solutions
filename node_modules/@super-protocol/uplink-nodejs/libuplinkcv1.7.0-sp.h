...
//
extern UplinkProjectResult uplink_config_open_project(UplinkConfig config, UplinkAccess* access, int* MaximumConcurrent);
...
//
extern UplinkProjectResult uplink_open_project(UplinkAccess* access, int* MaximumConcurrent);
