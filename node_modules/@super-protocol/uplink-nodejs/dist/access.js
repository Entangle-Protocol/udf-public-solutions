...
class AccessResultStruct {
     ...
     */
    async openProject(maximumConcurrent) {
        const project = await uplink.open_project(this.access, maximumConcurrent !== null && maximumConcurrent !== void 0 ? maximumConcurrent : 0).catch((error) => {
     ...
     * Output : Project(Object)
     */
    async configOpenProject(config, maximumConcurrent) {
        const project = await uplink.config_open_project(this.access, config, maximumConcurrent !== null && maximumConcurrent !== void 0 ? maximumConcurrent : 0).catch((error) => {
            errorhandle.storjException(error.error.code, error.error.message);
        }), projectResultReturn = new project_js_1.ProjectResultStruct(project.project);
        return projectResultReturn;
    }
